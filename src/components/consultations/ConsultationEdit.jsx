...
const ConsultationForm = (props) => {
  ...
  useEffect(() => {
    getConsultation(props.match.params.consultationId).then((consultation) => {
      setForm(consultation)
      getPet(consultation.petId).then((pet) => setPet(pet))
    })
  ...
  return (
    <>
      ...
      <div className='container'>
        <div className='row'>
          <div className='container'>
            <h5 className='my-3'>Editando Consulta de {pet.name}</h5>
            <form>
